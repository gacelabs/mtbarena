	...
	<!-- page nav -->
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-9 col-md-9 col-sm-9 col-xs-padding <?php echo(!empty($page_right_column['column_visibility_class']) ? $page_right_column['column_visibility_class'] : ''); ?>">
					<?php
